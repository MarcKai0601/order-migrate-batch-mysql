...
public class EltProperties {
     ...
     */
    private int halfDaySwitchThreshold = 20_000;

    /**
     * 🚦當「半天窗口」預估缺口再超過這個值時，會把該半天切成「一小時一小時」搬。
     * 例：80_000 = 8 萬筆以上就用每小時切。
     */
    private int hourSwitchThreshold = 5_000;

    /**
     * 🚦當「預估批次數」超過這個值時，視為太多批，需要往下一級切分
     * 例如：一天預估 >3 批，就切成「半天」；半天預估 >3 批，就切成「每小時」
     */
    private int maxBatchesBeforeSplit = 3;
